    ...
    return(
        <div class="container fluid">
            ...
            <div className="row" style={{width:"100%",height:"300px"}}>
                ...
                <div className="col-sm-2" style={{width:"194.3px",height:"250px"}}>
                    <img src="https://media.casioindiashop.com/assets/images/pair-watch-tile.webp"  class="img-fluid"style={{width:"270px",height:"247px"}}></img>
                </div>
                <div className="col-sm-2" style={{width:"194.3px",height:"250px"}}>
                    <img src="https://cdn1.smartprix.com/rx-iW3MXV8NS-w420-h420/zte-nubia-watch.jpg"  class="img-fluid"style={{width:"270px",height:"247px"}}></img>
                </div>
                <div className="col-sm-2" style={{width:"194.333px",height:"250px"}}>
                    <img src="https://staticimg.titan.co.in/Titan/Catalog/2693WM01_1.jpg"  class="img-fluid"style={{width:"270px",height:"247px"}}></img>
                </div>
