        ...
        <div class="container fluid">
            <ul className="itembar mx-5 my-3 p:0">
                ...
                <div><h4>Shoes</h4></div>
                    ...
                    <div className="col-sm-2 border" style={{width:"194.3px",height:"250px"}}>
                    ...
                    <div className="col-sm-2 border" style={{width:"194.333px",height:"250px"}}>
                    ...
                    <div className="col-sm-2 border" style={{width:"194.4px",height:"250px"}}>
